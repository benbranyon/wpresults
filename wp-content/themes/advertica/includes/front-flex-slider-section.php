	...
	<ul class="slides">
		...
		<li> 
			...
			<p class="flex-caption">
				...
				<?php if($excerpt) { ?><span class="text"><?php echo $excerpt; ?></span><?php } ?>
		...
		<?php endwhile; ?>
		<?php else : ?>
		<div class="post"><img alt="advertica-default-slider-image" class="default-slider-image"  src="<?php echo get_template_directory_uri();?>/images/advertica.jpg" ></div>
		<?php endif; ?>
		<?php wp_reset_query();?>
	</ul>
</div>
