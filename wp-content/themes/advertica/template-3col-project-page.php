...
<?php 
	$skt_port_filter_hide  = sketch_get_option($advertica_shortname.'_hide_pro_filter');
	...
	<div class="container post-wrap">
		<div class="row-fluid">
			...
			<div id="content" class="span12">
								...
								<dl class="group maingroup">
									...
									<dd>
										<ul class="filter group" id="isofilters">
											<li><a href="JavaScript:void(0);" data-filter="*" class="selected"><?php _e('show all','advertica'); ?></a></li>
											<?php
							...
							<div id="container-isotop" class="portfolio group three-col">
								...
								<div class="item project_box span4 <?php echo $data_type;$data_type =null; ?>" data-type="<?php echo $data_type;$data_type =null; ?>" data-id="id-<?php echo $data_id; ?>">
									...
									<div class="project-item" id="post-<?php the_ID(); ?>">
										...
										$image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'advertica_portfolio_three_image' );
				...
				<?php endwhile; ?>
				<?php else : ?>
					<div class="post"><h2><?php _e('Not Found','advertica'); ?></h2></div>
				<?php endif; ?>
			</div>
			<!-- Content -->
		</div>
