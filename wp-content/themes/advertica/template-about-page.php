	...
	<div class="team-division container">
		...
		<div class="our_team_member">
			<div class="team_custom_title title_center"> 
				<?php if(sketch_get_option($advertica_shortname.'_teammember_title')) { ?><h3><?php echo sketch_get_option($advertica_shortname.'_teammember_title'); ?></h3><span class="border_center"> </span><?php } ?>
				<p><?php if(sketch_get_option($advertica_shortname.'_teamsub_title')) { echo sketch_get_option($advertica_shortname.'_teamsub_title'); } ?></p>
			</div>
			<!--team-container-->

			<div class="team-box row-fluid"> 
				<?php $count=1;
					if(sketch_get_option($advertica_shortname.'_numbet_team_member')){ $skt_numbet_team_member = sketch_get_option($advertica_shortname.'_numbet_team_member'); } 
				?>
				...
				<div class="team-box-mid span4 <?php if($count%3==0){?>no-margin<?php }?>">
					<div class="teammember">
						...
						<div class="team-name-deg">
							...
							<strong class="team_prof"><?php echo $job; ?></strong>	
						</div>
						<p>
						<?php 
							$_team_cont_limit = sketch_get_option($advertica_shortname.'_team_cont_limit');
							$_team_cont_limit = (isset($_team_cont_limit) && $_team_cont_limit !="") ? $_team_cont_limit : '20';
							echo advertica_slider_limit_words($content, $_team_cont_limit); 
						?>
						</p>
						<ul class="teamsocial">
