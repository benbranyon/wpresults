...
function skt_quote_metabox_callback() { ?>
	<div class="inner" id="citation">
		...
		<h4><?php _e('Author Url','advertica');?></h4>
...
function skt_video_metabox_callback() { ?>
	<div class="inner" id="video">
		<h4><?php _e('Put the YouTube Video Url Here.','advertica');?></h4>
		...
		<h4><?php _e('OR','advertica');?></h4>
		<h4><?php _e('Put the Vimeo Video Url Here.','advertica');?></h4>
...
function skt_gallery_metabox_callback() { ?>
	<div class="inner" id="slider">
		<h4><?php _e('you can use image attachment or nothing...','advertica');?></h4>
		<h4><?php _e('Slider Auto Scroll on/off','advertica');?></h4>
		<select id="skt_postType_slider_auscroll" name="_skt_postType_slider_auscroll" style="width:50%;">
			...
			<option value="true" <?php selected('true', $autoscroll);?>><?php _e('true','advertica');?></option>
			<option value="false" <?php selected('false', $autoscroll);?>><?php _e('false','advertica');?></option>
		</select>	
		<h4><?php _e('Slider direction Navigation on/off','advertica');?></h4>
		<select id="skt_postType_slider_direction" name="_skt_postType_slider_direction" style="width:50%;">
			...
			<option value="true" <?php selected('true', $direction);?>><?php _e('true','advertica');?></option>
			<option value="false" <?php selected('false', $direction);?>><?php _e('false','advertica');?></option>
		</select>	
	</div>
<?php }
