...
function skt_teammember_posttype_init() {
	...
	$skt_teammember_labels = array(
		...
		'name' =>  ucwords($advertica_shortname).__(' Team Member','advertica' ),

		'singular_name' => _x('teammember', 'post type singular name','advertica'),

		'add_new' => _x('Add New', 'team member','advertica'),

		'add_new_item' => __('Add New Team Member','advertica'),

		'edit_item' => __('Edit Team Member','advertica'),

		'new_item' => __('New Team Member','advertica'),

		'all_items' => __('All Team Member','advertica'),

		'view_item' => __('View Team Member','advertica'),

		'search_items' => __('Search Team Member','advertica'),

		'not_found' =>  __('No Team Member found','advertica'),

		'not_found_in_trash' => __('No Team Member found in Trash','advertica'), 

		'parent_item_colon' => '',

		'menu_name' => ucwords($advertica_shortname).__(' Team','advertica')
...
function skt_team_member_metabox_callback() { ?>
	...
	<table width="100%">	
		...
		<tr class="alternate">
			...
			<th class="left"><?php _e('Content','advertica');  ?></th>
		...
		<tr class="alternate">
			...
			<th class="left"><?php _e('By (Name)','advertica');  ?></th>
		...
		<tr class="alternate" >
			...
			<th class="left"><?php _e('Avatar','advertica') ?></th>
			...
			<td>
				...
				<p>
					...
					<label for="upload_image">
						...
						<span class="hint"><b><?php _e('Recommend Width 370px and Height 208px.', 'advertica'); ?></b></span>
		...
		<tr class="alternate">
			...
			<th class="left"><?php _e('Job title','advertica');  ?></th>
		...
		<tr class="alternate">
			...
			<th class="left"><?php _e('Website','advertica');  ?></th>
		...
		<tr class="alternate">
			...
			<th class="left"><?php _e('Facebook Url','advertica');  ?></th>
		...
		<tr class="alternate">
			...
			<th class="left"><?php _e('Twitter Url','advertica');  ?></th>
		...
		<tr class="alternate">
			...
			<th class="left"><?php _e('Dribbble Url','advertica');  ?></th>
		...
		<tr class="alternate">
			...
			<th class="left"><?php _e('Mail id','advertica');  ?></th>
		...
		<tr class="alternate">
			...
			<th class="left"><?php _e('Skype id','advertica');  ?></th>
