...
<ul id="skt-frontpage-sections">
	...
	if(isset($_skt_frontpage_sections_order) && $_skt_frontpage_sections_order !="") {
		...
		$_skt_frontpage_sections_order = array('Featured Box Section','Call to Action Section','Latest Project Section','Content Box with Parallax Effect Section','Team Member Section','Statistics Section','Client Logo Section','Page Content');
	}
...
if ( empty( $ids ) ) {
	$ids = array( __( 'No slides found, please add some slides', 'advertica' ) );
}

$meta_box_page_revolution = array(
	'id' => 'advertica-meta-box-page-revolution',
	'title' =>  __( 'Revolution Slider Settings', 'advertica' ),
	'page' => 'page',
	'context' => 'normal', 
	'priority' => 'default',
	'fields' => array(
		array( 
			"name" => __( 'Revolution Slider', 'advertica' ),
			"desc" => __( 'Choose Revolution Slider you would like to display.', 'advertica' ),
...
<table>
  <tr>
    <td>
		<h4><?php _e('Slider Section','advertica');?></h4>
	</td>
	<td>
		<div class="skt-slider-set inputbox">
		  <div class="tab-slider">
			<label for="skt_allslider_metabox3"><input type="radio" name="_skt_allslider_metabox" id="skt_allslider_metabox3" class="skt_allslider_metabox" value="video" rel="video" checked="checked" <?php checked('video', $frontslider_set_meta); ?> /><?php _e('Video &nbsp;&nbsp;&nbsp;&nbsp;','advertica') ?></label>
		    <label for="skt_allslider_metabox1"><input type="radio" name="_skt_allslider_metabox" id="skt_allslider_metabox1" class="skt_allslider_metabox" value="flex" rel="flex"  <?php checked('flex', $frontslider_set_meta); ?> /><?php _e('Flex Slider &nbsp;&nbsp;&nbsp;&nbsp;','advertica') ?></label> 
			<label for="skt_allslider_metabox2"><input type="radio" name="_skt_allslider_metabox" id="skt_allslider_metabox2" class="skt_allslider_metabox" value="rev" rel="rev"  <?php checked('rev', $frontslider_set_meta); ?> /><?php _e('Revolution Slider &nbsp;&nbsp;&nbsp;&nbsp;','advertica') ?></label>
			<label for="skt_allslider_metabox4"><input type="radio" name="_skt_allslider_metabox" id="skt_allslider_metabox4" class="skt_allslider_metabox" value="withoutall" rel="withoutall" <?php checked('withoutall', $frontslider_set_meta); ?>/><?php _e('None of these &nbsp;&nbsp;&nbsp;&nbsp;','advertica') ?></label>
		  </div>
		  <div class="allslider-inner" id="rev" <?php if($frontslider_set_meta == "rev") { echo "style='display:block;'"; } ?>>
			<input type="hidden" name="advertica_meta_box_nonce" value="<?php wp_create_nonce(basename(__FILE__)) ?>" />
				<table class="form-table advertica-custom-table">
					<?php
		 ...
		 <div class="allslider-inner" id="video" <?php if($frontslider_set_meta == "video") { echo "style='display:block;'"; } ?>>
			<strong><?php _e('Put video url ( Youtube or Vimeo )','advertica');?></strong>
  ...
  <tr>
    <td>
		<h4><?php _e('Call to Action Section','advertica');?></h4>
	</td>

	<td>
		<div class="inputbox">
			<label for="skt_calltoaction_metabox1"><input type="radio" name="_skt_calltoaction_metabox" id="skt_calltoaction_metabox1" value="1" checked="checked"  <?php checked(1, $ctameta); ?> /><?php _e('Enable &nbsp;&nbsp;&nbsp;&nbsp;','advertica') ?></label>
			<label for="skt_calltoaction_metabox2"><input type="radio" name="_skt_calltoaction_metabox" id="skt_calltoaction_metabox2" value="0" <?php checked(0, $ctameta); ?> /><?php _e('Disable','advertica') ?></label>
		</div>
	</td>
   </tr>
  ...
  <tr>
    <td>
		<h4><?php _e('Latest Project Section','advertica');?></h4>
	</td>
	
	<td>
		<div class="inputbox">
			<label for="skt_latestproject_metabox1"><input type="radio" name="_skt_latestproject_metabox" id="skt_latestproject_metabox1" value="1" checked="checked"  <?php checked(1, $latestprojectmeta); ?> /><?php _e('Enable &nbsp;&nbsp;&nbsp;&nbsp;','advertica') ?></label>
			<label for="skt_latestproject_metabox2"><input type="radio" name="_skt_latestproject_metabox" id="skt_latestproject_metabox2" value="0" <?php checked(0, $latestprojectmeta); ?> /><?php _e('Disable','advertica') ?></label>
		</div>
	</td>
   </tr>
  ...
  <tr>
   ...
   <tr>
    <td>
		<h4><?php _e('Team Member Section','advertica');?></h4>
	</td>
	
	<td style="">
		<div class="inputbox">
			<label for="skt_teammember_metabox1"><input type="radio" name="_skt_teammember_metabox" class="skt_teammember_metabox" id="skt_teammember_metabox1" value="1" rel="team_open"  checked="checked"  <?php checked(1, $teammembermeta);?> /><?php _e('Enable &nbsp;&nbsp;&nbsp;&nbsp;','advertica') ?></label>
			<label for="skt_teammember_metabox2"><input type="radio" name="_skt_teammember_metabox" class="skt_teammember_metabox" id="skt_teammember_metabox2" value="0" rel="team_close"  <?php checked(0, $teammembermeta);?> /><?php _e('Disable','advertica') ?></label>
		</div>
		...
		<div class="team_member_items" <?php if($teammembermeta === "1") { echo "style='display:block;'"; } ?>>
			<div class="team_member_settings" <?php if($teammembermeta === "1") { echo "style='display:block;'"; } ?>>
				<label for="skt_teammember_call1"><input type="radio" name="_skt_teammember_call" id="skt_teammember_call1" class="skt_teammember_call" value="latest" rel="latest" checked="checked"   <?php checked('latest', $teammembermetacall);?> /><?php _e('Latest Team Members &nbsp;&nbsp;&nbsp;&nbsp;','advertica') ?></label>
				<label for="skt_teammember_call2"><input type="radio" name="_skt_teammember_call" id="skt_teammember_call2" class="skt_teammember_call" value="specific" rel="specific"  <?php checked('specific', $teammembermetacall);?> /><?php _e('Specific Team Members &nbsp;&nbsp;&nbsp;&nbsp;','advertica') ?></label>
			</div>
			...
			<div class="team_member_selections" id="specific" <?php if($skt_teammember_call_meta === "specific" && $teammembermeta === "1") { echo "style='display:block;'"; } ?>>
				<?php
					$teamposts = get_posts('post_type=team_member');
					if(!$teamposts) {
						_e('<b style="color:red;">Please Add Team Members To Select.</b>','advertica');
					}
				?>

				<div class="team_blocks">
					<?php
						$teampostype = get_posts('post_type=team_member');
						if($teampostype) : ?>
						<label for="team_memsel1"><?php _e('First Team Member','advertica');?></label>
				...
				<?php
					if($teampostype) : ?>
					<label for="team_memsel2"><?php _e('Second Team Member','advertica');?></label>
				...
				<?php
					$teampostype = get_posts('post_type=team_member');
					if($teampostype) : ?>
					<label for="team_memsel3"><?php _e('Third Team Member','advertica');?></label>
    ...
    <tr>
    <td>
		<h4><?php _e('Statistics Section','advertica');?></h4>
	</td>
	<td>
		<div class="inputbox">
			<label for="skt_statics_metabox1"><input type="radio" name="_skt_statics_metabox" id="skt_statics_metabox1" class="skt_statics_metabox" rel="statics_open" value="1" checked="checked"  <?php checked(1, $skt_statics_meta); ?> /><?php _e('Enable &nbsp;&nbsp;&nbsp;&nbsp;','advertica') ?></label>
			<label for="skt_statics_metabox2"><input type="radio" name="_skt_statics_metabox" rel="statics_close" id="skt_statics_metabox2" class="skt_statics_metabox" value="0" <?php checked(0, $skt_statics_meta); ?> /><?php _e('Disable','advertica') ?></label>
		</div>
		<div class="skt-statics-inner" id="statics_open" <?php if($skt_statics_meta === "1") { echo "style='display:block;'"; } ?>>
			<strong><?php _e('Put Statistics Here:','advertica');?></strong>
			<textarea id="skt_staticsarea_section" name="_skt_staticsarea_section" style="width:100%;"><?php echo get_post_meta($post->ID, '_skt_staticsarea_section',true);?></textarea>
	    </div>
	</td>
   </tr>
   ...
   <tr>
    <td>
		<h4><?php _e('Twitter Feed Section','advertica');?></h4>
	</td>

	<td>
		<div class="inputbox">
			<label for="skt_twfeed_metabox1"><input type="radio" name="_skt_twfeed_metabox" id="skt_twfeed_metabox1" value="1"  <?php checked(1, $tweetfeedmeta);?> /><?php _e('Enable &nbsp;&nbsp;&nbsp;&nbsp;','advertica') ?></label>
			<label for="skt_twfeed_metabox2"><input type="radio" name="_skt_twfeed_metabox" id="skt_twfeed_metabox2" value="0"  <?php checked(0, $tweetfeedmeta);?> /><?php _e('Disable','advertica') ?></label>
		</div>
	</td>
   </tr>
</table>	
