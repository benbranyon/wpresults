...
<table>
	<tr>
		<td>
			<h4><?php _e('Page Title','advertica');?></h4>
		</td>
	<td>
		<div class="inputbox">
			<label for="skt_pagetitle_metabox1"><input type="radio" name="_skt_pagetitle_metabox" id="skt_pagetitle_metabox1" value="1" checked="checked"  <?php checked(1, $value);?> /><?php _e('Enable &nbsp;&nbsp;&nbsp;&nbsp;','advertica') ?></label>
			<label for="skt_pagetitle_metabox2"><input type="radio" name="_skt_pagetitle_metabox" id="skt_pagetitle_metabox2" value="0" <?php checked(0, $value);?> /><?php _e('Disable','advertica') ?></label>
		</div>
	</td>
   </tr>
  ...
  <tr>
	<td>
		<h4><?php _e('Page Title Background Image','advertica');?></h4>
	</td>
	<td>
		<p>
			<label for="upload_image">
				...
				<span class="hint"><?php _e('Recommend width:1600px and height:450px ', 'advertica'); ?></span>
			</label>
		</p>
	 </td>
  </tr>
