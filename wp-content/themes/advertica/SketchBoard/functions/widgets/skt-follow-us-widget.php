...
class SktFollowWidget extends WP_Widget {
    ...
    function SktFollowWidget() {
		global $advertica_themename;
		$widget_ops = array('classname' => 'SktFollowContact', 'description' => "Sketch Themes widget for Follow Us - $advertica_themename footer" );
		$this->WP_Widget('SktFollowWidget',"Follow Us - $advertica_themename",$widget_ops);	
    }
	 ...
	 if(isset($instance['follow_flickr'])){
	  ...
	  if(isset($instance['follow_foursquare'])){
        ...
        ?>
		 ...
		 <?php _e('Title:','advertica'); ?> <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php if(isset($title)){ echo $title; } ?>" />
         </label></p>
		 <p>
         </p>
         <p>
			<label for="<?php echo $this->get_field_id('follow_linkedin'); ?>"><?php _e('Link for Linkedin','advertica'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_linkedin'); ?>" name="<?php echo $this->get_field_name('follow_linkedin'); ?>" type="text" value="<?php if(isset($follow_linkedin)){ echo $follow_linkedin; }?>" /></label>
         </p>
         <p>
			<label for="<?php echo $this->get_field_id('follow_facebook'); ?>"><?php _e('Link for Facebook','advertica'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_facebook'); ?>" name="<?php echo $this->get_field_name('follow_facebook'); ?>" type="text" value="<?php if(isset($follow_facebook)){ echo $follow_facebook; }?>" /></label>
         </p>
         <p>
			<label for="<?php echo $this->get_field_id('follow_twitter'); ?>"><?php _e('Link for Twitter','advertica'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_twitter'); ?>" name="<?php echo $this->get_field_name('follow_twitter'); ?>" type="text" value="<?php if(isset($follow_twitter)){ echo $follow_twitter; }?>" /></label>
         </p>
         <p>
			<label for="<?php echo $this->get_field_id('follow_flickr'); ?>"><?php _e('Link for Flickr','advertica'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_flickr'); ?>" name="<?php echo $this->get_field_name('follow_flickr'); ?>" type="text" value="<?php if(isset($follow_flickr)){ echo $follow_flickr; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_gplusicon'); ?>"><?php _e('Link for Google+','advertica'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_gplusicon'); ?>" name="<?php echo $this->get_field_name('follow_gplusicon'); ?>" type="text" value="<?php if(isset($follow_gplusicon)){ echo $follow_gplusicon; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_skype'); ?>"><?php _e('Skype UserID','advertica'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_skype'); ?>" name="<?php echo $this->get_field_name('follow_skype'); ?>" type="text" value="<?php if(isset($follow_skype)){ echo $follow_skype; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_youtube'); ?>"><?php _e('Link for YouTube','advertica'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_youtube'); ?>" name="<?php echo $this->get_field_name('follow_youtube'); ?>" type="text" value="<?php if(isset($follow_youtube)){ echo $follow_youtube; }?>" /></label>
         </p>
		  <p>
			<label for="<?php echo $this->get_field_id('follow_dribble'); ?>"><?php _e('Link for Dribble','advertica'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_dribble'); ?>" name="<?php echo $this->get_field_name('follow_dribble'); ?>" type="text" value="<?php if(isset($follow_dribble)){ echo $follow_dribble; }?>" /></label>
         </p>
		  <p>
			<label for="<?php echo $this->get_field_id('follow_pinterest'); ?>"><?php _e('Link for Pinterest','advertica'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_pinterest'); ?>" name="<?php echo $this->get_field_name('follow_pinterest'); ?>" type="text" value="<?php if(isset($follow_pinterest)){ echo $follow_pinterest; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_tumblr'); ?>"><?php _e('Link for Tumblr','advertica'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_tumblr'); ?>" name="<?php echo $this->get_field_name('follow_tumblr'); ?>" type="text" value="<?php if(isset($follow_tumblr)){ echo $follow_tumblr; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_github'); ?>"><?php _e('Link for Github','advertica'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_github'); ?>" name="<?php echo $this->get_field_name('follow_github'); ?>" type="text" value="<?php if(isset($follow_github)){ echo $follow_github; }?>" /></label>
         </p>
		 <p>
			<label for="<?php echo $this->get_field_id('follow_foursquare'); ?>"><?php _e('Link for Foursquar','advertica'); ?> <input class="widefat" id="<?php echo $this->get_field_id('follow_foursquare'); ?>" name="<?php echo $this->get_field_name('follow_foursquare'); ?>" type="text" value="<?php if(isset($follow_foursquare)){ echo $follow_foursquare; }?>" /></label>
         </p>
        <?php 
    }
}
