...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		global $advertica_shortname;
		$of_page = add_theme_page( ucwords($advertica_shortname).__(' Options', 'advertica'), ucwords($advertica_shortname).__(' Options', 'advertica'), 'edit_theme_options', 'options-framework','optionsframework_page');
