...
function advertica_theme_setup() {
	...
	add_image_size( 'advertica_portfolio_image',270,230,true); //remove if slider is not needed
	add_image_size( 'advertica_portfolio_three_image',372,372,true); //remove if slider is not needed
	add_image_size( 'advertica_portfolio_two_image',570,470,true); //remove if slider is not needed
	add_image_size( 'advertica_standard_img',770,365,true); //standard size
	add_image_size( 'advertica_fullblog_img',1170,556,true); //Full Blog size
...
/*---------------------------------------------------------------------------*/
 if ( !defined( 'ADVERTICA_REQUIRED_PLUGINS' ) ) {
	define( 'ADVERTICA_REQUIRED_PLUGINS', trailingslashit(get_theme_root()) . 'advertica/includes/plugins' );
}
