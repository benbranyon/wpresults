								...
								<?php $post_id = get_the_ID();
										...
										$youtube_src1 = get_post_meta($post->ID, '_skt_postType_youtubevideo', true);
											if(preg_match('/http:\/\/(www\.)*youtube\.com\/.*/',$youtube_src1)){
												...
												<div class="flex-video widescreen vimeo">
													<iframe width="770" height="442" src="https://www.youtube.com/embed/<?php echo $advertica_yvideo_id; ?>?wmode=opaque" frameborder="0" class="youtube-video" allowfullscreen></iframe>
												</div>
												<?php 
											} 
										}
									if (get_post_meta($post->ID, '_skt_postType_vimeovideo', true)){
										...
										if(preg_match('/http:\/\/(www\.)*vimeo\.com\/.*/',$vimeo_src1)){
											...
											?>
											<div class="flex-video widescreen vimeo">
												<iframe src='https://player.vimeo.com/video/<?php echo $advertica_vvideo_id; ?>?portrait=0' width='770' height='442' frameborder='0'></iframe>
											</div>
											<?php 
										} 
									} 
