			...
			<div class="video-container">
				<?php $post_id =  get_the_ID();
					...
					<div class="flex-video widescreen vimeo">
						<iframe width="1170" height="556" src="https://www.youtube.com/embed/<?php echo $advertica_yvideo_id; ?>?wmode=opaque" class="youtube-video" allowfullscreen></iframe>
					</div>
					<?php } }
					...
					?>
					<div class="flex-video widescreen vimeo">
						<iframe src="https://player.vimeo.com/video/<?php echo $advertica_vvideo_id; ?>?portrait=0" width='1170' height='556'></iframe>
					</div>
					<?php } } ?>
			</div>
		</div>
